...
#define HAVE_call_internal3a (!(Pmode == DImode) && !TARGET_ABICALLS && TARGET_LONG_CALLS)
#define HAVE_call_internal3b (Pmode == DImode && !TARGET_ABICALLS && TARGET_LONG_CALLS)
...
#define HAVE_movdicc (mips_isa >= 4)
